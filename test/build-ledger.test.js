...
const { buildLedger, candidateToLedgerEvent, makeEventId, minutesToJstIso } = require('../scripts/lib/build-ledger');
...
test('candidateToLedgerEvent: displayName未解決はFALLBACK_KIND_LABELを使いrule_generatedになる', () => {
  const used = new Set();
  const candidate = {
